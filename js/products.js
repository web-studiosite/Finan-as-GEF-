    ...
    <div class="space-y-5">
      ...
      <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-5 rounded-2xl bg-slate-900 border border-slate-800">
        ...
        <div class="flex items-center gap-2">
          <button id="btnRefreshProducts" class="flex items-center gap-1.5 px-3 py-2 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs font-semibold transition border border-slate-700 cursor-pointer">
            <i data-lucide="refresh-cw" class="w-3.5 h-3.5"></i>
            <span>Recarregar do Banco</span>
          </button>
          <button id="btnNewProduct" class="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-orange-600 hover:bg-orange-500 text-white text-xs font-bold shadow-md shadow-orange-950/40 transition active:scale-95 cursor-pointer">
        ...
        <tr class="hover:bg-slate-800/40 transition">
          ...
          <td class="py-3 px-4 text-center">
            <div class="inline-flex items-center gap-1">
              <button class="btn-edit-prod p-1.5 rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-white transition cursor-pointer" data-id="${p.id}" title="Editar">
                <i data-lucide="edit-2" class="w-3.5 h-3.5"></i>
              </button>
              <button class="btn-delete-prod p-1.5 rounded-lg bg-slate-800 hover:bg-red-950 text-slate-400 hover:text-red-400 transition cursor-pointer" data-id="${p.id}" title="Inativar">
  ...
  modalContainer.innerHTML = `
    <div class="relative w-full max-w-2xl my-6 rounded-2xl bg-slate-900 border border-slate-700 p-6 shadow-2xl space-y-4 max-h-[90vh] overflow-y-auto text-xs text-slate-200">
      <div class="flex items-center justify-between pb-3 border-b border-slate-800">
        ...
        <button id="closeModalBtn" class="text-slate-400 hover:text-white p-1 cursor-pointer">
      ...
      <form id="productForm" class="space-y-4">
        ...
        <div class="flex justify-end gap-2 pt-3 border-t border-slate-800">
          <button type="button" id="cancelModalBtn" class="px-4 py-2 rounded-xl bg-slate-800 text-slate-300 hover:bg-slate-700 font-semibold cursor-pointer">
            Cancelar
          </button>
          <button type="submit" id="saveProductSubmitBtn" class="px-5 py-2 rounded-xl bg-orange-600 hover:bg-orange-500 text-white font-bold shadow-md shadow-orange-950/40 cursor-pointer">
