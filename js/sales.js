  ...
  container.innerHTML = `
    <div class="space-y-5">
      ...
      <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-5 rounded-2xl bg-slate-900 border border-slate-800">
        ...
        <button id="btnRefreshSales" class="flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs font-semibold transition border border-slate-700 cursor-pointer">
        ...
        <tr class="hover:bg-slate-800/40 transition ${isCanceled ? 'opacity-60 bg-red-950/10' : ''}">
          ...
          <td class="py-3 px-4 text-center">
            <div class="inline-flex items-center gap-1.5">
              <button class="btn-receipt p-1.5 rounded-lg bg-slate-800 hover:bg-slate-700 text-orange-400 transition cursor-pointer" data-id="${sale.id}" title="Reemitir Recibo Térmico">
                <i data-lucide="printer" class="w-3.5 h-3.5"></i>
              </button>
              ${!isCanceled ? `
                <button class="btn-reverse p-1.5 rounded-lg bg-slate-800 hover:bg-red-900/50 text-slate-400 hover:text-red-400 transition cursor-pointer" data-id="${sale.id}" title="Estorno Reverso Atômico">
