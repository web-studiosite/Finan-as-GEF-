    ...
    <div class="space-y-6 text-xs text-slate-200">
      ...
      <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-5 rounded-2xl bg-slate-900 border border-slate-800">
        ...
        <div class="flex items-center gap-2">
          <button id="btnDashPos" class="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-orange-600 hover:bg-orange-500 text-white text-xs font-bold shadow-md shadow-orange-950/40 transition active:scale-95 cursor-pointer">
            <i data-lucide="shopping-cart" class="w-4 h-4"></i>
            <span>Abrir PDV / Venda (F4)</span>
          </button>
          <button id="btnRefreshDash" class="p-2 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-300 border border-slate-700 transition cursor-pointer" title="Atualizar Indicadores">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div class="lg:col-span-2 p-5 rounded-2xl bg-slate-900 border border-slate-800 space-y-3">
          <div class="flex items-center justify-between">
            ...
            <button id="btnViewAllSales" class="text-[11px] font-semibold text-orange-400 hover:text-orange-300 transition cursor-pointer">
              Ver Todas &rarr;
            </button>
          </div>
        ...
        <div class="p-5 rounded-2xl bg-slate-900 border border-slate-800 space-y-3">
          ...
          <div class="space-y-2">
            <button id="quickBtnNewProduct" class="w-full p-3 rounded-xl bg-slate-800 hover:bg-slate-700 border border-slate-700 text-left flex items-center gap-3 transition cursor-pointer">
            ...
            <button id="quickBtnStockTransfer" class="w-full p-3 rounded-xl bg-slate-800 hover:bg-slate-700 border border-slate-700 text-left flex items-center gap-3 transition cursor-pointer">
            ...
            <button id="quickBtnReports" class="w-full p-3 rounded-xl bg-slate-800 hover:bg-slate-700 border border-slate-700 text-left flex items-center gap-3 transition cursor-pointer">
